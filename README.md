...
This Project was modelled after the Class Diagram provided of a basic Employee Management System with inheritance happening at a domain class level as per this diagram and not database level, MappedSuperClass JPA Inheritance.
![Image of UML Diagram](https://raw.githubusercontent.com/DTaksta/employeeCRUD/master/screenshots/classDiagram.png)
The App starts with a Landing Page where you can log in as a user or admin with the instructions listed on the page.
![App Login](https://raw.githubusercontent.com/DTaksta/employeeCRUD/master/screenshots/homePageUserLogin.png)
Once logged in as either user or admin you can select an entity employee or company and move from there.
Here is the sample Employee list view -
![Employee List](https://raw.githubusercontent.com/DTaksta/employeeCRUD/master/screenshots/EmpList.png)
and Create Employee View
![Employee Create](https://raw.githubusercontent.com/DTaksta/employeeCRUD/master/screenshots/createEmp.png)
and Edit Employee View -
![Employee Edit](https://raw.githubusercontent.com/DTaksta/employeeCRUD/master/screenshots/editEmp.png)

Furthermore, if one logs into Admin, you can see the API documentation for these services as generated by SwaggerUI under Administration -> API as shown in the following screenshot.
![API docs part one](https://raw.githubusercontent.com/DTaksta/employeeCRUD/master/screenshots/apidocs-p1.png)
and
![API docs part two](https://raw.githubusercontent.com/DTaksta/employeeCRUD/master/screenshots/apidocs-p2.png)
