// TODO.Get these tests to work with employee person inheritance,
// calls Person class not Employee for some reason, so manual inheritance 
// broke this functionality that Jhipster never catered for originally.
...
//         int databaseSizeBeforeTest = employeeRepository.findAll().size();
//         // set the field null
//         employee.setAddressPhysical(null);
...
//         int databaseSizeBeforeTest = employeeRepository.findAll().size();
//         // set the field null
//         employee.setAddressPostal(null);
...
//         int databaseSizeBeforeTest = employeeRepository.findAll().size();
//         // set the field null
//         employee.setTelephoneNumber(null);
