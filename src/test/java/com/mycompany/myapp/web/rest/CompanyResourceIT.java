...
public class CompanyResourceIT {
    ...
    public void createCompany() throws Exception {
        ...
        assertThat(testCompany.getAddressPhysical()).isEqualTo(DEFAULT_ADDRESS_PHYSICAL);
        assertThat(testCompany.getAddressPostal()).isEqualTo(DEFAULT_ADDRESS_POSTAL);
    ...
    public void updateCompany() throws Exception {
        ...
        assertThat(testCompany.getAddressPhysical()).isEqualTo(UPDATED_ADDRESS_PHYSICAL);
        assertThat(testCompany.getAddressPostal()).isEqualTo(UPDATED_ADDRESS_POSTAL);
