//Commented out this test as Person is now an Abstract class.
...
//         assertThat(testPerson.getAddressPhysical()).isEqualTo(DEFAULT_ADDRESS_PHYSICAL);
//         assertThat(testPerson.getAddressPostal()).isEqualTo(DEFAULT_ADDRESS_POSTAL);
...
//         int databaseSizeBeforeTest = personRepository.findAll().size();
//         // set the field null
//         person.setAddressPhysical(null);
...
//         assertThat(testPerson.getAddressPhysical()).isEqualTo(UPDATED_ADDRESS_PHYSICAL);
//         assertThat(testPerson.getAddressPostal()).isEqualTo(UPDATED_ADDRESS_POSTAL);
